...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.statusbar.showMessage("Output folder set to current user root. Run as is or change output folder.")
    ...
    def _on_change_dir(self):
        ...
        self.update_status_message(f"Output folder set to: {self.selected_folder}...")
    ...
    def _on_run(self):
        ...
        if self.sophos_id == "" or self.sophos_secret == "":
            self.update_status_message("Sophos ID or Secret Key is empty. Please try again")
            return None

        print(self.sophos_id)
        print(self.sophos_secret)
        self.update_status_message("Processing...")
        process_export(self.sophos_id,
                       self.sophos_secret,
                       f"{self.selected_folder}/sophos_exclusions.csv",
                       f"{self.selected_folder}/sophos_allowed.csv",
                       )
        self.update_status_message("Processing Complete!")
